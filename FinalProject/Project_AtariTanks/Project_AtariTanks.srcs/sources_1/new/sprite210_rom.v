...
module sprite210_rom(
	...
	case ({row_reg, col_reg})
		...
		6'b010101: pixel_data = blank;
		6'b010110: pixel_data = blank;
		6'b010111: pixel_data = blank; // Row 2 End
		
		6'b011000: pixel_data = blank;
		6'b011001: pixel_data = blank;
		6'b011010: pixel_data = mono_c;
		6'b011011: pixel_data = mono_c;
		6'b011100: pixel_data = mono_c;
		6'b011101: pixel_data = blank;
		6'b011110: pixel_data = blank;
		6'b011111: pixel_data = blank; // Row 3 End
		
		6'b100000: pixel_data = blank;
		6'b100001: pixel_data = blank;
		...
		6'b100111: pixel_data = blank; // Row 4 End
		...
		6'b101110: pixel_data = mono_c;
		6'b101111: pixel_data = mono_c; // Row 5 End
